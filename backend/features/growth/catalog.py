...
_TIER_CONCEPTS: dict[Tier, tuple[TierConcept, ...]] = {
    Tier.T1: (
        ...
        TierConcept(106, "compound_interest", "복리 효과"),
        TierConcept(107, "diversification", "분산투자"),
        TierConcept(108, "per_basics", "PER 기초"),
        TierConcept(109, "dividend_basics", "배당의 의미"),
        TierConcept(110, "timing_misconception", "타이밍 오해"),
    ),
    Tier.T2: (
        ...
        TierConcept(206, "financial_statements", "재무제표 읽기"),
        TierConcept(207, "pbr_basics", "PBR 이해"),
        TierConcept(208, "operating_margin", "영업이익률"),
        TierConcept(209, "debt_ratio", "부채비율"),
        TierConcept(210, "roe_basics", "ROE 이해"),
    ),
    Tier.T3: (
        ...
        TierConcept(306, "interest_rate_stocks", "금리와 주식"),
        TierConcept(307, "currency_effects", "환율의 영향"),
        TierConcept(308, "eps_and_growth", "EPS와 성장"),
        TierConcept(309, "growth_vs_value", "성장주 vs 가치주"),
        TierConcept(310, "economic_indicators", "경제 지표 해석"),
    ),
    Tier.T4: (
        ...
        TierConcept(406, "dcf_valuation", "DCF 밸류에이션"),
        TierConcept(407, "competitive_moat", "경쟁 우위(해자)"),
        TierConcept(408, "capital_allocation", "자본배분 효율성"),
        TierConcept(409, "leverage_risk", "레버리지 리스크"),
        TierConcept(410, "market_sentiment", "시장 심리와 수급"),
    ),
    Tier.T5: (
        ...
        TierConcept(506, "advanced_position_mgmt", "포지션 관리 고급"),
        TierConcept(507, "cognitive_bias", "인지 편향"),
        TierConcept(508, "liquidity_and_price", "유동성과 가격"),
        TierConcept(509, "alpha_generation", "알파 생성"),
        TierConcept(510, "portfolio_performance", "포트폴리오 성과 분석"),
    ),
}
